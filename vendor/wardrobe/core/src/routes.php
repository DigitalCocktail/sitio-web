...
Route::get('/blog/archive', array('uses' => $wardrobeControllers.'PostController@index', 'as' => 'wardrobe.posts.archive'));
Route::get('/blog/rss', array('uses' => $wardrobeControllers.'RssController@index', 'as' => 'wardrobe.posts.rss'));
...
Route::group(Config::get('core::routes.blog_group_rules'), function() use ($wardrobeControllers)
{
	...
	Route::get('/{slug}', array('uses' => $wardrobeControllers.'PostController@show', 'as' => 'wardrobe.posts.show'));
